...
LOG_MODULE_REGISTER(http_wifi_config, CONFIG_APP_LOG_LEVEL);

static struct json_obj_descr json_description[] = {
   JSON_OBJ_DESCR_PRIM(hei_http_wifi_config_t, name, JSON_TOK_STRING),
   JSON_OBJ_DESCR_PRIM(hei_http_wifi_config_t, password, JSON_TOK_STRING),
   JSON_OBJ_DESCR_PRIM(hei_http_wifi_config_t, security, JSON_TOK_STRING),
};
...
hei_http_json_decoding_result_t hei_http_wifi_config_from_json(char *src,
                                                               size_t src_size,
